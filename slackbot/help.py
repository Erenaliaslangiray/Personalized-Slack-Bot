...
def help():
    ...
    print("edit_env() ---> Allows you to configure Slack credentials and application settings.")
    print("send_message(message=None) ---> Allows you to send specified message via bot.")
    ...
    print("remove_reminder(rid=None) ---> Allows you to remove a reminder message.")
    print("")
